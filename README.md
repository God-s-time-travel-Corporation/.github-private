{"confirmationStore":{"confirmation":null},"qualSupplementStore":{"qualSupplementItems":[{"id":1,"question":"Why are you interested in pursuing a career in public service with the CIA?","answer":""},{"id":2,"question":"Please tell us about a time when you had to â€œthink on your feetâ€ and describe a separate situation when you had to keep a level head while under pressure.  What were each of those situations and how did you handle them?","answer":""},{"id":3,"question":"As a potential candidate, describe one thing from your academic, military, professional, or personal background that may have prepared you for success in the CIA.","answer":""},{"id":4,"question":"As a potential candidate, describe your interest or experience in foreign affairs, global events, or international travel that may have motivated you to consider a career in the CIA.","answer":""},{"id":5,"question":"As a potential candidate, outside of the careers to which you have expressed interest, what other careers may be of interest?","answer":""},{"id":6,"question":"Describe a time when you did not succeed, professionally or academically, and what you learned from that experience?&nbsp;(2 paragraphs)","answer":""}]},"personalStore":{"firstName":"","lastName":"","suffix":"","email":"","telephone":"","citizenshipStatus":"","locationConfirm":""},"coverletterStore":{"coverLetterItems":{"quesOne":"","quesTwo":""}},"drugAcknowledgeStore":{"drugAcknowledge":null},"cartStore":{"careerCart":[]}}{# .github-private
...
{# Xumm SDK [![npm version](https://badge.fury.io/js/xumm.svg)](https://www.npmjs.com/xumm) [![GitHub Actions NodeJS status](https://github.com/XRPL-Labs/Xumm-Universal-SDK/workflows/NodeJS/badge.svg?branch=main)](https://github.com/XRPL-Labs/Xumm-Universal-SDK/actions)
